 ...
 *
 * @package WordPress
 * @subpackage Articles of Unity
 * @since Articles of Unity 1.0
 */
...
function twentytwenty_register_styles() {
    ...
    // Add tailwind dist CSS
    wp_enqueue_style( 'tailwind-style', get_theme_file_uri('/dev/dist/tailwind.css'), array(), $theme_version );
...
function twentytwenty_menus() {
    ...
    $locations = array(
        'articlesPrimary'  => __( 'Desktop Primary Menu', 'articlesofunity' ),
        'articlesSecondary'  => __( 'Desktop Secondary Menu', 'articlesofunity' ),
        'expanded' => __( 'Desktop Expanded Menu', 'twentytwenty' ),
        'mobile'   => __( 'Mobile Menu', 'twentytwenty' ),
        'footer'   => __( 'Footer Menu', 'twentytwenty' ),
        'social'   => __( 'Social Menu', 'twentytwenty' ),
        'articlesLegal'  => __( 'Legal Menu', 'articlesofunity' ),
    );
